...
<?php
	...
	$sql = mysqli_query($conexao,"INSERT INTO  chamados 
		(tipo, dtAbertura, NomeRequerente,  setor, tpReparo, numInventario, status, prioridade, atribuicao, descricao) VALUES 
		('$tipo', '$dtAbertura', '$NomeRequerente', '$setor', '$tpReparo', '$numInventario', '$status', '$prioridade','$atribuicao', '$descricao')");
	echo "
	<form>
 ...
 ?>
 	...
 	<center><a href="form-cad-chamados.php" style="color:#134c6f">Clique aqui para novo cadastro</a></center>
